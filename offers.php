...
<body>
    ...
    <div class="contain" > 
    <div style="padding: 0 0 0 42%; border-radius: 6px;" class="gradient-delight-1">
                            ...
                            <div class="row">
                                <div class="col-s-8 col-m-7 col-l-9">
                                    <div class="margin-bottom-s">
                                        <h3>
                                            <!----><p class="font-xxxl font-weight-bold txt-primary margin-bottom-xs">Buffet Offers with Drinks</p>
                                            <!----><p class="font-md font-weight-semibold line-height-default txt-tertiary">+ 7 more Deals</p>
                                        </h3>
                                    </div>
                                    <!----><p class="font-lg line-height-xs">
                                        <span class="margin-right-xs">
                                            <span class="font-lg txt-secondary">Starting From :</span>
                                            <span class="font-lg txt-primary font-weight-bold">₹399</span>
                                        </span>
                                ...
                                <!----><div class="col-s-4 col-m-5 col-l-3">
                                    <button class="btn-delight font-xl txt-uppercase margin-bottom-s font-weight-semibold bg-delight-1">View</button>
                                </div>
                            </div>
                        </div>
</div>
